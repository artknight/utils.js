UTILS.Timerange=class extends UTILS.Base{constructor(data={}){if(super(data),"target"in data)return"options"in data&&this.setOptions(data.options),"range"in data&&this.setTimeRange(data.range),"date"in data&&this.setDate(data.date),"onShow"in data&&this.addCallback("onShow",data.onShow),"onHide"in data&&this.addCallback("onHide",data.onHide),"onStart"in data&&this.addCallback("onStart",data.onStart),"onStop"in data&&this.addCallback("onStop",data.onStop),"onSlide"in data&&this.addCallback("onSlide",data.onSlide),this._initSlider(),this;throw new Error("@target must be specified upon initialization!")}getDefaults(){return{object:"utils.timerange",version:"1.0.3",$wrapper:null,is_shown:!1,is_enabled:!0,date:moment(),is_date_editable:!0,time_format:"h:mm A",time_label_format:"h A",date_format:"MM/DD/YYYY",allow_past_dates:!1,EditableDate:null,range:{start:540,end:960},settings:{range:{min:0,max:1440},tooltips:[!0,!0],connect:!0,step:15,format:{to:this._formatDisplayTime.bind(this),from:function(val){return val}},pips:{mode:"steps",stepped:!0,density:4,format:{to:function(total_mins){var total_mins=this._getHoursMinsFromTotalMins(total_mins),time_label_format=this.getTimeLabelFormat();return moment(total_mins.hrs+":"+total_mins.mins,"HH:mm").format(time_label_format)}.bind(this),from:function(val){return val}},filter:function(value,type){return value%60==0?Math.floor(value/60)%2==1?2:1:0}}}}}clean(){return this.values.$wrapper.remove(),this}_create(){return this.values.$wrapper||(this.values.$wrapper=$(`
